    ...
    <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-900/90">
      ...
      <div className="mt-4 grid gap-4 md:grid-cols-2">
        ...
        <article className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-700 dark:bg-transparent">
          ...
          <pre className="mt-2 overflow-auto whitespace-pre-wrap rounded bg-slate-100 p-3 text-xs text-slate-800 dark:bg-slate-950 dark:text-slate-100">{question?.javaSolution || question?.solutionCode || '// Java solution not available.'}</pre>
        </article>
      </div>
      ...
      <div className="mt-5 flex flex-wrap gap-2">
        ...
        <button type="button" onClick={toggleBookmark} className="rounded border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 dark:border-slate-600 dark:text-slate-100">
